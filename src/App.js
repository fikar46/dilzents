...
import Diskusi from './component/folder/diskusi';
import Footer from './component/folder/Footer';
import Sbmptn from './component/folder/sbmptn';
import Un from './component/folder/un';
import Um from './component/folder/um';
import Uk from './component/folder/uk';
